...
def query_rag(query_text: str):
    ...
    # Load the Gemma-2 model and tokenizer with preset
    model = LocalGemma2ForCausalLM.from_pretrained(
        "google/gemma-2-9b",
        preset="auto",
        use_auth_token="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"  # Replace with your actual Hugging Face token
    )
    ...
    model_inputs = tokenizer(prompt, return_attention_mask=True, return_tensors="pt").to(model.device)
